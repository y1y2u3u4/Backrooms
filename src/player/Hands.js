...
const POSES = {
  idle_R: { p: [0.310, -0.340, -0.520], r: [-0.18, -0.24, 0.10], curl: [0.30, 0.32, 0.34, 0.38], thumb: 0.25 },
  idle_L: { p: [-0.330, -0.390, -0.560], r: [-0.10, 0.30, -0.14], curl: [0.22, 0.24, 0.26, 0.30], thumb: 0.18 },
  ...
  pry_R: { p: [0.305, -0.375, -0.500], r: [-0.24, -0.16, 0.22], curl: [0.88, 0.92, 0.94, 0.95], thumb: 0.78 },
};
