...
Generated 2026-07-30T07:41:32.913Z by `tools/qa/audio-render.mjs`. Every file here is
...
| [`beds/service.wav`](beds/service.wav) | `service` | 0.0 | -6.3 | 2.4 | 236 | CLIP |
| [`beds/cistern.wav`](beds/cistern.wav) | `cistern` | 0.1 | -8.3 | 3.5 | 196 | CLIP |
| [`beds/residence.wav`](beds/residence.wav) | `dead` | -0.6 | -15.7 | 6.6 | 267 | — |
| [`beds/plant.wav`](beds/plant.wav) | `hall` | 0.0 | -6.6 | 2.8 | 232 | CLIP |
| [`beds/duct.wav`](beds/duct.wav) | `duct` | -0.4 | -12.9 | 4.5 | 175 | — |
| [`beds/stack.wav`](beds/stack.wav) | `stack` | 0.0 | -6.1 | 2.6 | 229 | CLIP |
| [`beds/safe.wav`](beds/safe.wav) | `safe` | -0.9 | -15.4 | 5.4 | 278 | — |

### `beds/intake.wav` — intake

Peak -0.1 dBFS, RMS -6.1 dBFS, crest 2.6, spectral centroid 121 Hz, 235 voices spawned over the excerpt. Reverb profile `corridor`.
...
Peak 0.0 dBFS, RMS -6.3 dBFS, crest 2.4, spectral centroid 157 Hz, 236 voices spawned over the excerpt. Reverb profile `service`.
...
Peak 0.1 dBFS, RMS -8.3 dBFS, crest 3.5, spectral centroid 134 Hz, 196 voices spawned over the excerpt. Reverb profile `cistern`.
...
Peak -0.6 dBFS, RMS -15.7 dBFS, crest 6.6, spectral centroid 130 Hz, 267 voices spawned over the excerpt. Reverb profile `dead`.
...
Peak 0.0 dBFS, RMS -6.6 dBFS, crest 2.8, spectral centroid 221 Hz, 232 voices spawned over the excerpt. Reverb profile `hall`.
...
Peak -0.4 dBFS, RMS -12.9 dBFS, crest 4.5, spectral centroid 139 Hz, 175 voices spawned over the excerpt. Reverb profile `duct`.
...
Peak 0.0 dBFS, RMS -6.1 dBFS, crest 2.6, spectral centroid 160 Hz, 229 voices spawned over the excerpt. Reverb profile `stack`.
...
Peak -0.9 dBFS, RMS -15.4 dBFS, crest 5.4, spectral centroid 125 Hz, 278 voices spawned over the excerpt. Reverb profile `safe`.
...
- **Clipping:** 4 artefact(s) clipped.
- **Within 0.2 dB of full scale:** 1.
- **Inaudibly quiet:** 0 — none.

### Failures

- bed service: 366 clipped samples (peak 1.002)
- bed cistern: 502 clipped samples (peak 1.012)
- bed plant: 4956 clipped samples (peak 1.002)
- bed stack: 128 clipped samples (peak 1.000)
