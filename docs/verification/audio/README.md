...
Generated 2026-07-30T18:51:16.252Z by `tools/qa/audio-render.mjs`. Every file here is
...
|---|---|---:|---:|---:|---:|---|
| [`beds-still/intake.wav`](beds-still/intake.wav) | `corridor` | -2.8 | -9.6 | 2.8 | 91 | — |
| [`beds-still/service.wav`](beds-still/service.wav) | `service` | -2.4 | -9.6 | 2.5 | 93 | — |
| [`beds-still/cistern.wav`](beds-still/cistern.wav) | `cistern` | -2.5 | -13.0 | 4.2 | 88 | — |
| [`beds-still/residence.wav`](beds-still/residence.wav) | `dead` | -6.9 | -25.2 | 7.2 | 100 | — |
| [`beds-still/plant.wav`](beds-still/plant.wav) | `hall` | -2.5 | -10.1 | 2.8 | 88 | — |
| [`beds-still/duct.wav`](beds-still/duct.wav) | `duct` | -6.0 | -21.8 | 6.6 | 24 | — |
| [`beds-still/stack.wav`](beds-still/stack.wav) | `stack` | -2.6 | -9.4 | 2.7 | 87 | — |
| [`beds-still/safe.wav`](beds-still/safe.wav) | `safe` | -5.7 | -23.9 | 8.5 | 87 | — |

### `beds-still/intake.wav` — intake

Peak -2.8 dBFS, RMS -9.6 dBFS, crest 2.8, spectral centroid 163 Hz, 91 voices spawned over the excerpt. Reverb profile `corridor`.
...
Peak -2.4 dBFS, RMS -9.6 dBFS, crest 2.5, spectral centroid 137 Hz, 93 voices spawned over the excerpt. Reverb profile `service`.
...
Peak -2.5 dBFS, RMS -13.0 dBFS, crest 4.2, spectral centroid 121 Hz, 88 voices spawned over the excerpt. Reverb profile `cistern`.
...
Peak -6.9 dBFS, RMS -25.2 dBFS, crest 7.2, spectral centroid 171 Hz, 100 voices spawned over the excerpt. Reverb profile `dead`.
...
Peak -2.5 dBFS, RMS -10.1 dBFS, crest 2.8, spectral centroid 116 Hz, 88 voices spawned over the excerpt. Reverb profile `hall`.
...
Peak -6.0 dBFS, RMS -21.8 dBFS, crest 6.6, spectral centroid 108 Hz, 24 voices spawned over the excerpt. Reverb profile `duct`.
...
Peak -2.6 dBFS, RMS -9.4 dBFS, crest 2.7, spectral centroid 168 Hz, 87 voices spawned over the excerpt. Reverb profile `stack`.
...
Peak -5.7 dBFS, RMS -23.9 dBFS, crest 8.5, spectral centroid 142 Hz, 87 voices spawned over the excerpt. Reverb profile `safe`.
