...
Generated 2026-07-30T19:51:29.069Z by `tools/qa/audio-render.mjs`. Every file here is
...
|---|---|---:|---:|---:|---:|---|
| [`beds-still/intake.wav`](beds-still/intake.wav) | `corridor` | -6.1 | -19.5 | 4.2 | 91 | — |
| [`beds-still/service.wav`](beds-still/service.wav) | `service` | -5.0 | -17.9 | 4.3 | 93 | — |
| [`beds-still/cistern.wav`](beds-still/cistern.wav) | `cistern` | -9.9 | -26.5 | 5.8 | 88 | — |
| [`beds-still/residence.wav`](beds-still/residence.wav) | `dead` | -20.5 | -40.5 | 7.6 | 100 | — |
| [`beds-still/plant.wav`](beds-still/plant.wav) | `hall` | -7.2 | -20.1 | 4.6 | 88 | — |
| [`beds-still/duct.wav`](beds-still/duct.wav) | `duct` | -18.4 | -35.8 | 6.0 | 24 | — |
| [`beds-still/stack.wav`](beds-still/stack.wav) | `stack` | -6.1 | -18.1 | 4.1 | 87 | — |
| [`beds-still/safe.wav`](beds-still/safe.wav) | `safe` | -22.0 | -39.5 | 8.6 | 87 | — |

### `beds-still/intake.wav` — intake

Peak -6.1 dBFS, RMS -19.5 dBFS, crest 4.2, spectral centroid 113 Hz, 91 voices spawned over the excerpt. Reverb profile `corridor`.
...
Peak -5.0 dBFS, RMS -17.9 dBFS, crest 4.3, spectral centroid 121 Hz, 93 voices spawned over the excerpt. Reverb profile `service`.
...
Peak -9.9 dBFS, RMS -26.5 dBFS, crest 5.8, spectral centroid 185 Hz, 88 voices spawned over the excerpt. Reverb profile `cistern`.
...
Peak -20.5 dBFS, RMS -40.5 dBFS, crest 7.6, spectral centroid 150 Hz, 100 voices spawned over the excerpt. Reverb profile `dead`.
...
Peak -7.2 dBFS, RMS -20.1 dBFS, crest 4.6, spectral centroid 74 Hz, 88 voices spawned over the excerpt. Reverb profile `hall`.
...
Peak -18.4 dBFS, RMS -35.8 dBFS, crest 6.0, spectral centroid 128 Hz, 24 voices spawned over the excerpt. Reverb profile `duct`.
...
Peak -6.1 dBFS, RMS -18.1 dBFS, crest 4.1, spectral centroid 130 Hz, 87 voices spawned over the excerpt. Reverb profile `stack`.
...
Peak -22.0 dBFS, RMS -39.5 dBFS, crest 8.6, spectral centroid 139 Hz, 87 voices spawned over the excerpt. Reverb profile `safe`.
