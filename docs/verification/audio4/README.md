...
Generated 2026-07-30T07:50:50.552Z by `tools/qa/audio-render.mjs`. Every file here is
...
|---|---|---:|---:|---:|---:|---|
| [`beds/intake.wav`](beds/intake.wav) | `corridor` | -2.7 | -9.7 | 2.9 | 92 | — |
| [`beds/service.wav`](beds/service.wav) | `service` | -2.4 | -9.8 | 2.6 | 94 | — |
| [`beds/cistern.wav`](beds/cistern.wav) | `cistern` | -2.2 | -12.5 | 4.0 | 75 | — |
| [`beds/residence.wav`](beds/residence.wav) | `dead` | -5.0 | -23.8 | 8.1 | 102 | — |
| [`beds/plant.wav`](beds/plant.wav) | `hall` | -2.4 | -10.3 | 3.0 | 93 | — |
| [`beds/duct.wav`](beds/duct.wav) | `duct` | -3.4 | -21.0 | 7.9 | 79 | — |
| [`beds/stack.wav`](beds/stack.wav) | `stack` | -2.5 | -9.4 | 2.7 | 91 | — |
| [`beds/safe.wav`](beds/safe.wav) | `safe` | -7.6 | -23.3 | 5.6 | 112 | — |

### `beds/intake.wav` — intake

Peak -2.7 dBFS, RMS -9.7 dBFS, crest 2.9, spectral centroid 151 Hz, 92 voices spawned over the excerpt. Reverb profile `corridor`.
...
Peak -2.4 dBFS, RMS -9.8 dBFS, crest 2.6, spectral centroid 228 Hz, 94 voices spawned over the excerpt. Reverb profile `service`.
...
Peak -2.2 dBFS, RMS -12.5 dBFS, crest 4.0, spectral centroid 333 Hz, 75 voices spawned over the excerpt. Reverb profile `cistern`.
...
Peak -5.0 dBFS, RMS -23.8 dBFS, crest 8.1, spectral centroid 165 Hz, 102 voices spawned over the excerpt. Reverb profile `dead`.
...
Peak -2.4 dBFS, RMS -10.3 dBFS, crest 3.0, spectral centroid 221 Hz, 93 voices spawned over the excerpt. Reverb profile `hall`.
...
Peak -3.4 dBFS, RMS -21.0 dBFS, crest 7.9, spectral centroid 180 Hz, 79 voices spawned over the excerpt. Reverb profile `duct`.
...
Peak -2.5 dBFS, RMS -9.4 dBFS, crest 2.7, spectral centroid 175 Hz, 91 voices spawned over the excerpt. Reverb profile `stack`.
...
Peak -7.6 dBFS, RMS -23.3 dBFS, crest 5.6, spectral centroid 156 Hz, 112 voices spawned over the excerpt. Reverb profile `safe`.
